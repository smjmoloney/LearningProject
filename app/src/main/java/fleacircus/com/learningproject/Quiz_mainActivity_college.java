...
public class Quiz_mainActivity_college extends AppCompatActivity {
    ...
    private void generateQuestions() {
        ...
        if (total == questionCount) {
            Intent startResult = new Intent(Quiz_mainActivity_college.this, Quiz_resultActivity.class);
            ...
            DocumentReference docRef = db.collection("Quizzes").document(collegeLocation)
                    .collection(quizName + " - " + collegeLocation).document(quizName);
            docRef.get()
                    .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                opt1.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (opt1.getText().toString().equals(quizAnswer)) {
                                            ...
                                            Toast.makeText(Quiz_mainActivity_college.this, "You Are Correct", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(Quiz_mainActivity_college.this, "You Are Incorrect", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(Quiz_mainActivity_college.this, "Document does not exist", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
